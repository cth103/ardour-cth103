...
#ifndef __gtk_ardour_note_event__
#define __gtk_ardour_note_event__
 ...
 */
class NoteEvent : virtual public sigc::trackable
{
  public:
	...
	virtual ~NoteEvent();
        ...
        static PBD::Signal1<void, NoteEvent*> NoteEventDeleted;
...
#endif /* __gtk_ardour_note_event_h__ */
