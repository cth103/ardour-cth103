	...
	, _automation (other._automation)
{
	...
	init (
		other.item_name, other.frames_per_pixel, c, other.frame_position,
...
TimeAxisViewItem::init (
	const string& it_name, double fpp, Gdk::Color const & base_color, framepos_t start, framepos_t duration, Visibility vis, bool wide, bool high)
{
	item_name = it_name;
